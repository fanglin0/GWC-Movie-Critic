...
print(favMovie + "is rated 64 points higher than the lowest rated movie.")
print()

#find max
max = comedyMovieData["audience_rating"].max()
print("The max audience rating of the data set is: " + str(max))
print(favMovie + " is rated 36 points lower than the highest rated movie.")
print()
...
plt.grid(True)
plt.title("Audience Rating of Comedy Movies Histogram")
plt.xlabel("Audience Rating")
plt.ylabel("Number of COmedy Movies")

#Prints interpretation of histogram
print(
  "According to the histogram, most comedy movies fall between audience rating 40 and 80."
)
...
print(
  "According to the scatter plot, audience rating and critic rating largely matches."
)
print()
